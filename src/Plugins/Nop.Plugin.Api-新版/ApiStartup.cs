...
namespace Nop.Plugin.Api
{
   ...
   //using IdentityServer4.EntityFramework.Entities.ApiResource;
    ...
    public class ApiStartup : INopStartup
    {
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
         ...
         //   var containerBuilder = new ContainerBuilder();
           // containerBuilder.RegisterGeneric(typeof(PluginManager<>)).As(typeof(IPluginManager<>)).InstancePerLifetimeScope();
            //containerBuilder.RegisterType<PluginService>().As<IPluginService>().InstancePerLifetimeScope();
        ...
        private void AddTokenGenerationPipeline(IServiceCollection services)
        {
            ...
            //services.AddIdentityServer(x => x.UserInteraction.LoginUrl = "/login")
